...
Answer these questions individually first. Afterwards, you'll discuss responses with your group members.
...
4. What are some considerations in deciding what variables to include in a regression model?<br><br>
5. How might regression models be useful in understanding the causal effect of some variable on an outcome?
